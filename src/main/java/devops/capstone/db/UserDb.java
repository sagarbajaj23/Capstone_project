...
public class UserDb {
	...
	public UserDb(){
		...
		User u2=new User("Trimula","Sivananda","abcd","tirumala.sivananda@gmail.com","trimu4567");
		User u3=new User("Raghavendra","Krishna Simha","pqrs","raghavendra.simha@gmail.com","ragha6789");
